...
dbListFields(con,"mtcars") # Lista todos os campos da tabela
...
df
str(df)
sapply(df, class) #Lista a classe dos campos

hist(df$setembro)

df_mean <- unlist(lapply(df[, c(4, 5, 6, 7, 8)], mean)) #Cálcula a média dos meses
df_mean
