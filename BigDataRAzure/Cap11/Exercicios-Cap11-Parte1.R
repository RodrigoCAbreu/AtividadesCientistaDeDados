...
plot(x, y1, main = "Relacionamento X e Y1", xlab = "X", ylab = "Y1")
...
a <- regressao$coefficients[1]
b <- regressao$coefficients[2]
...
plot(Idade, Tempo, main = "Relação Idadade x Tempo", xlab = "Idade", ylab = "Tempo")
...
names(alturas2) <- c("altura")

a <- modelo1$coefficients[1]
b <- modelo1$coefficients[2]
