...
?table
str(carros)
table(carros$cor) #contagem das cores
table(carros$modelo) #contagem dos modelos
str(carros)
...
head(carros)
carros$conserv <- carros$cor %in% c("Preto", "Cinza", "Prata", "Branco") #passa um vetor com os atributos desejados
head(carros)
