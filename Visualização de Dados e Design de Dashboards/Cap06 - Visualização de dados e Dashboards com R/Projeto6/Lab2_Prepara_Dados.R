...
# Script de Preparação dos Dados

# Defina seu diretório de trabalho
getwd()

# Instala pacotes (somente uma vez)
...
# Agrupamento 2 - Variável natlty (nacionalidade que sofreu o ataque)
...
# Agrupamento 3 - Variável targtype (tipo de alvo do ataque)
...
# Agrupamento 4 - Variável Region (região onde ocorreu o ataque)
...
# Agrupamento 5 - Variável Weapon (arma usada no ataque)
...
# Agrupamento 6 - Variável attacktype (tipo de ataque)
...
# Agrupamento 7 - Variável country (país que sofreu o ataque)
...
# Se o título estiver vazio colocamos "Unknown"
natltyTable$Title <- ifelse(natltyTable$Title == "", "Unknown", as.character(natltyTable$Title))

# Ajustamos esse título pois é muito longo
